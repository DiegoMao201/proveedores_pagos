...
import { Home, Building2, TrendingUp, Layers, BarChart3, Percent, Receipt } from "lucide-react";
...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/reglas-descuento", label: "Reglas de descuento", icon: Percent },
      { href: "/reglas-retencion", label: "Reglas de retención", icon: Receipt },
    ],
  },
];
